function [PR, PRU, imgvssize, imgvstime] = process(directory, filename, gt_neigh, compensate)
    ...
    loops_filename = strcat(directory, filename);
    ...
    for i=1:nimages
        ...
        % Images vs Time
        imgvstime.img(i) = i;
        imgvstime.time(i) = loops_file(i, 5);
    end
end